...
export class DataService {
  ...
  public getdestinations() {
    return this.httpClient
      .get(
        `${this.baseUrl}timadventures.php?class=timAdventures&method=destination`
      )
      .pipe(
        map((res: any) => {
          return res;
  ...
  getAttractions(destination?: any) {
    return this.httpClient
      .get(
        `${this.baseUrl}timadventures.php?class=timAdventures&method=attractions&destination="${destination}"`
      )
      .pipe(
        map((res: any) => {
          return res;
  ...
  getServices(attraction?: any) {
    return this.httpClient
      .get(
        `${this.baseUrl}timadventures.php?class=timAdventures&method=services&attraction="${attraction}"`
      )
      .pipe(
        map((res: any) => {
          return res;
  ...
  getServiceDetails($attraction: string, $service: string, $type: string) {
    return this.httpClient
      .get(
        `${this.baseUrl}timadventures.php?class=timAdventures&method=getServiceDetails&attraction="${$attraction}"&service=${$service}&type=${$type}`
      )
      .pipe(
        map((res: any) => {
          return res;
